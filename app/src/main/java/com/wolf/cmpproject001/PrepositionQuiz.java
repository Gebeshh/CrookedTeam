...
public class PrepositionQuiz extends AppCompatActivity {
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putInt("remember",remember);
    ...
    protected void onRestoreInstanceState(Bundle savedInstance){
        if(savedInstance!=null) {
            remember = savedInstance.getInt("remember");
            score = savedInstance.getInt("score");
            counter = savedInstance.getInt("counter");
            answer = savedInstance.getString("answer");
            if(resimler.get(remember)=="Behind"){
                question.setImageResource(R.drawable.behind_empty);
                answer="Behind";
            }else if(resimler.get(remember)=="Between"){
                question.setImageResource(R.drawable.between_empty);
                answer="Between";
            }else if(resimler.get(remember)=="In"){
                question.setImageResource(R.drawable.in_empty);
                answer="In";
            }else if(resimler.get(remember)=="InFrontOf"){
                question.setImageResource(R.drawable.in_front_empty);
                answer="InFrontOf";
            }else if(resimler.get(remember)=="Near"){
                question.setImageResource(R.drawable.near_empty);
                answer="Near";
            }else if(resimler.get(remember)=="Under"){
                question.setImageResource(R.drawable.under_empty);
                answer="Under";
            }else if(resimler.get(remember)=="On"){
                question.setImageResource(R.drawable.on_empty);
                answer="On";
            }
